# Generated by Powerlevel10k configuration wizard on 2019-08-30 at 08:51 CEST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 20177.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=12
  ...
  local vcs=''
  # If on a branch...
  vcs+='${${VCS_STATUS_LOCAL_BRANCH:+%118F'${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}
  ...
  vcs+='${${VCS_STATUS_NUM_STAGED:#0}:+ %184F+${VCS_STATUS_NUM_STAGED}}'
  # !42 if have unstaged changes.
  vcs+='${${VCS_STATUS_NUM_UNSTAGED:#0}:+ %184F!${VCS_STATUS_NUM_UNSTAGED}}'
  # ?42 if have untracked files. It's really a question mark, your font isn't broken.
  # See POWERLEVEL9K_VCS_UNTRACKED_ICON below if you want to use a different icon.
  # Remove the next line if you don't want to see untracked files at all.
  vcs+='${${VCS_STATUS_NUM_UNTRACKED:#0}:+ %45F'${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}'${VCS_STATUS_NUM_UNTRACKED}}'
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=45
